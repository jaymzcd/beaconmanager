...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'beacon_location', 'latitude',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.longitude'
        db.add_column(u'beacon_location', 'longitude',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'beacon_location', 'latitude')

        # Deleting field 'Location.longitude'
        db.delete_column(u'beacon_location', 'longitude')
