...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Beacon.request_count'
        db.alter_column(u'beacon_beacon', 'request_count', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Beacon.request_count'
        db.alter_column(u'beacon_beacon', 'request_count', self.gf('django.db.models.fields.IntegerField')())
